...
# --- RAILWAY VOLUME BEÁLLÍTÁSA ---
# Létrehozzuk a mappát, ha nem létezne a Volume-on belül
...
# ÚJ SOR: Ez figyeli a Tenor, Giphy linkeket és a .gif végű direkt linkeket
...
def init_db():
    conn = sqlite3.connect(DB_FILE) # Átírva, hogy a Volume-ra mentsen
    cursor = conn.cursor()
