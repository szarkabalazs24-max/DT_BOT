...
# IDE ÍRD BE A SAJÁT ID-DAT (Vagy add meg a Railway Variables-nél OWNER_ID néven)
OWNER_ID = int(os.getenv("OWNER_ID", 1461432399362658408)) 
...
if not os.path.exists(PERSISTENT_DATA_PATH):
    try:
        ...
        PERSISTENT_DATA_PATH = "./" # Ha nincs jogosultság, a helyi mappába ment
